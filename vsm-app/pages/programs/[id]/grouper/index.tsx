...
const AddGrouper = () => {
  ...
  return (
    <>
      ...
      <MetadataContainer style={{ columnGap: '12px' }}>
        <Col >
          ...
          <SearchInput value={name} label="Name (autogenerated from title)" readonly={true} id="name" placeholder={name || '---'} />
        ...
        <Col>
          ...
          <SearchInput readonly={true} label="Version (autogenerated)" id="version" placeholder={programVersion || ''} />
        </Col>
      </MetadataContainer>
