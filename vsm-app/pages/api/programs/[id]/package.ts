...
const crmiPackage = async (req: NextApiRequest, res: NextApiResponse<fhir4.Bundle | string | { error: string }>): Promise<void> => {
  ...
  try {
    ...
    if (!useV2) {
      ...
      if (response == null || planDefinition == null) {
        logger.error('Could not find either Plan Def or bundle in response')
        return res.status(500).json({ error: 'Failed to export' })
      }
      const v1Response = await fetch(`${fhirCdrClient.baseUrl}/$ersd-v2-to-v1-transform`, {
        // body: JSON.stringify({
                ...
                entry: [
                      ...
                      action: [
                        {
                          id: 'start-workflow',
                          description:
                            'This action represents the start of the reporting workflow in response to the encounter-start event.',
                        ...
                        },
                        {
                          ...
                          description:
                            'This action represents the start of the check suspected disorder reporting workflow in response to the encounter-start event.',
                          textEquivalent:
                          ...
                          action: [
                            {
                              ...
                              description:
                                'This action represents the check for suspected disorder reportability to create the patients eICR.',
                              ...
                              condition: [
                                {
                                  ...
                                  expression: {
                                    ...
                                    language: 'text/fhirpath',
                                    expression:
                                      '%modifiedConditions.exists() or %modifiedLabResults.exists() or %modifiedMedicationOrders.exists()'
                                  }
                                }
                              ],
                              input: [
                              ...
                              condition: [
                                {
                                  ...
                                  expression: {
                                    ...
                                    language: 'text/fhirpath',
                                    expression:
                                      "%encounter.where((status = 'in-progress' and period.start + 1 day * %normalReportingDuration >= now()) or (status = 'finished' and period.end + 72 hours >= now())).select(true)"
                                  }
                                }
                              ],
                              relatedAction: [
                              ...
                              condition: [
                                {
                                  ...
                                  expression: {
                                    ...
                                    language: 'text/fhirpath',
                                    expression:
                                      '((%lasteicr.last().entry[2].resource as Bundle).entry.first().resource as Composition).date < now() - 72 hours'
                                  }
                                }
                              ],
                              input: [
                              ...
                              condition: [
                                {
                                  ...
                                  expression: {
                                    ...
                                    language: 'text/fhirpath',
                                    expression:
                                      "%inprogressencounter.where(status = 'in-progress' and period.start + 1 day * %normalReportingDuration >= now() or (status = 'finished' and period.end + 72 hours >= now())).exists()"
                                  }
                                }
                              ],
                              input: [
                        ...
                        },
                        {
                          ...
                          description:
                            'This action represents the start of the reporting workflow in response to the encounter-modified event',
                  ...
                  },
                  {
                    ...
                    resource: {
                      ...
                      meta: {
                        ...
                        profile: ['http://hl7.org/fhir/us/ecr/StructureDefinition/us-ph-triggering-valueset-library']
                      },
                      text: {
                        status: 'generated',
                      ...
                      description:
                        'This release includes code updates for the existing conditions and adds codes for Parkinsonâ€™s disease and 13 enteric conditions. Medication codes have also been added to this version.',
                      useContext: [
                        {
                          code: {
                            system: 'http://hl7.org/fhir/us/ecr/CodeSystem/us-ph-usage-context-type',
                  ...
                  },
                  {
                    ...
                    resource: {
                      ...
                      compose: {
                        include: [
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1506']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1505']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1508']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1507']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.6']
                          }
                        ]
                      },
                      expansion: {
                  ...
                  },
                  {
                    ...
                    resource: {
                      ...
                      compose: {
                        include: [
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.480']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.481']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.761']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1223']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.762']
                          }
                        ]
                      },
                      expansion: {
                  ...
                  },
                  {
                    ...
                    resource: {
                      ...
                      compose: {
                        include: [
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1182']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1181']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.480']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1184']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.481']
                          }
                  ...
                  },
                  {
                    ...
                    resource: {
                      ...
                      compose: {
                        include: [
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.528']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.408']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.409']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1469']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1468']
                          }
                        ]
                      },
                      expansion: {
                  ...
                  },
                  {
                    ...
                    resource: {
                      ...
                      compose: {
                        include: [
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1439']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1436']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1435']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1446']
                          },
                          {
                            valueSet: ['http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1146.1438']
                          }
                        ]
                      },
                      expansion: {
                  ...
                  },
                  {
                    ...
                    resource: {
                      ...
                      title:
                        'Eastern Equine Encephalitis Virus Disease (Tests for Eastern Equine Encephalitis Virus Antibody [Quantitative])',
                      status: 'active',
                      experimental: true,
                      publisher: 'eCR',
                      description:
