...
describe('semverHelpers', () => {
  ...
  describe('getLatestFromList', () => {
    ...
    const UNSORTED_3 = ['2.3.4-draft', '3.4.5-draft', '0.0.0']
    const EXPECTED_3 = '3.4.5-draft'
    it('returns the latest semver taking into account three compartments with tag', () => {
      expect(getLatestFromList(UNSORTED_3)).toBe(EXPECTED_3)
    })

    const UNSORTED_4 = ['eee', '2.3.4-draft', '3.4.5-draft', '0.0.0']
    const EXPECTED_4 = '3.4.5-draft'
