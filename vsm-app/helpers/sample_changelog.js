            ...
            conditions: [
              {
                ...
                operation: {
                  type: "delete",
                  path: "relatedArtifact[3].extension[0].value.text",
                  oldValue: "Infection caused by Acanthamoeba (disorder)"
                }
              }
            ],
            priority: {}
            ...
            conditions: [
              {
                value: {
                  ...
                  valueCodeableConcept: {
                    ...
                    text: "someReplacedCondition"
                  }
                },
                operation: {
                  type: "replace",
                  path: "relatedArtifact[3].extension[0].value.coding[0].code",
                  oldValue: "49649001"
                }
              },
              {
